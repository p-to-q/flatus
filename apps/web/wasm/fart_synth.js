...
export function listPersonalities() {
    ...
    let deferred1_1;
    try {
        const ret = wasm.listPersonalities();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @param {boolean} headphones
 * @returns {Uint8Array}
 */
export function renderWav(personality, seed, pressure, headphones) {
    const ptr0 = passStringToWasm0(personality, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.renderWav(ptr0, len0, seed, pressure, headphones);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('fart_synth_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
